...
Download all the lecture slides [here](https://modules.lancaster.ac.uk/mod/folder/view.php?id=2738584) in both .pptx and .pdf format.
...
If you want to have a play around with the script yourself, the R markdown script and dataset can be downloaded [here](https://modules.lancaster.ac.uk/mod/folder/view.php?id=2738587).
...
The presentation given at the start of the lab can be downloaded [here](https://modules.lancaster.ac.uk/mod/resource/view.php?id=2738589).

## Datasets

The datasets for this lab can be downloaded [here](https://modules.lancaster.ac.uk/mod/folder/view.php?id=2738590).
...
A model script showing one way of answering the reptile research question above using R will be available next week. 

A model script showing one way of answering the (optional) pen research question will be available next week.


## Feedback on student scripts

[Here](https://modules.lancaster.ac.uk/mod/folder/view.php?id=2738595) is feedback on the one valid student submission this week. 
...
The WBA can be accessed [here](https://modules.lancaster.ac.uk/mod/quiz/view.php?id=2738528). Each student gets three attempts. We recommend having a go at the WBA following the lecture and lab. We recommend saving at least one attempt for revision purposes close in time to the class test.
