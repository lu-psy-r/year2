...
Download all the lecture slides [here](https://modules.lancaster.ac.uk/mod/folder/view.php?id=2738597) in both .pptx and .pdf format.
...
If you want to have a play around with the script yourself, the R markdown script and dataset can be downloaded [here](https://modules.lancaster.ac.uk/mod/folder/view.php?id=2738600). The script also contains an example of how to run a multiple binary logistic regression model in R. 
...
The presentation given at the start of the lab can be downloaded [here](https://modules.lancaster.ac.uk/mod/resource/view.php?id=2738602).

## Datasets

The datasets for this lab can be downloaded [here](https://modules.lancaster.ac.uk/mod/folder/view.php?id=2738603).
...
The WBA can be accessed [here](https://modules.lancaster.ac.uk/mod/quiz/view.php?id=2738529). You will need the following [dataset](https://modules.lancaster.ac.uk/mod/resource/view.php?id=2738530) to complete the WBA. Each student gets three attempts. We recommend having a go at the WBA following the lecture and lab. We recommend saving at least one attempt for revision purposes close in time to the class test.
