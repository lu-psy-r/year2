...
The lecture and lab materials, including slides, data and R files are downloaded from [here](data/Wk2/Week_12_234_Materials.zip) as a zip file. You can upload the zip file directly on to the R server and it will populate a new folder with the files and data files automatically.
