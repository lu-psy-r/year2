...
Download all the lecture slides [here](https://modules.lancaster.ac.uk/mod/folder/view.php?id=2738558) in both .pptx and .pdf format.
...
If you want to have a play around with the script yourself, the R markdown script and datasets can be downloaded [here](https://modules.lancaster.ac.uk/mod/folder/view.php?id=2738560).
...
The presentation given at the start of the lab can be downloaded [here](https://modules.lancaster.ac.uk/mod/resource/view.php?id=2738562).

## Datasets

The datasets for this lab can be downloaded [here](https://modules.lancaster.ac.uk/mod/folder/view.php?id=2738563). 
...
[Here](https://modules.lancaster.ac.uk/mod/folder/view.php?id=2738566) is some feedback on a few scripts submitted by students.
...
The WBA can be accessed [here](https://modules.lancaster.ac.uk/mod/quiz/view.php?id=2738525). Each student gets three attempts. We recommend having a go at the WBA following the lecture and lab. We recommend saving at least one attempt for revision purposes close in time to the class test.
...
```{r echo = FALSE} 
model1 <- wilcox_test(admin_tasks ~ tea_group, data = tea_dataset, paired = FALSE)
model1
...
If you have any questions about this week's content, please post them on the module moodle discussion board.
