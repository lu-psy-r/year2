...
The link to this week's multiple choice quiz, WBA 5, is [here](https://modules.lancaster.ac.uk/mod/quiz/view.php?id=2738524)
...
## Model script for Factor Analysis

The model scripts are the ones posted for the lab activities - so I will not post them again on the moodle.
...
[here](https://modules.lancaster.ac.uk/mod/folder/view.php?id=2738554).
...
If you have any questions about the binomial test, please post them on the moodle discussion board
the discussion board.

## Model script for Binomial Test

Amy did not leave a model script for posting for the binomial test.